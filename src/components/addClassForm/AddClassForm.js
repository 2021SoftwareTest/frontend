    ...
    return (
      <div className="class-card">
        ...
        <div className="class-textbook">
          ...
          <Row>
            <Col span={24}>
              <TextArea value={this.state.textbooks} placeholder="请填写课程详情" autoSize={{ minRows: 3, maxRows: 5 }} onChange={this.textbooksOnChange} />
            </Col>
          </Row>
        </div>
        <div className="class-intro">
          ...
          <Row>
            <Col span={24}>
              <TextArea value={this.state.introduction} placeholder="请填写课程简介" autoSize={{ minRows: 5, maxRows: 8 }} onChange={this.introductionOnChange} />
            </Col>
          </Row>
        </div>
