            ...
            <div className="homework-header">
                <Row>
                    ...
                    <Col span={3} offset={15} style={{display:"flex", paddingTop:3}}>
                        <Button className="homework-button"><EyeOutlined />btn1</Button>
                        <Button className="homework-button"><StarOutlined />btn2</Button>
                        <Button className="homework-button">btn3</Button>
                    </Col>
                </Row>
                <Row>
                    <Col span={24}>
