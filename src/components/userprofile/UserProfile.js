                ...
                <Row style={{ marginTop: 10 }}>
                  <Col span={12}>
                    <Form.Item name="id" label="学号" rules={[{ required: true, message: '请输入学号' }]}>
                      <Input placeholder="学号或工号" style={{ width: 240, height: 40, borderRadius: 5 }} value={this.state.userId} onChange={this.IDOnChange} />
                    </Form.Item>
                  </Col>
                  <Col span={12}>
                    <Form.Item name="name" label="姓名" rules={[{ required: true, message: '请输入姓名' }]}>
                      <Input placeholder="请输入姓名" style={{ width: 240, height: 40, borderRadius: 5 }} value={this.state.userName} onChange={this.usernameOnChange} />
                    </Form.Item>
                  </Col>
                </Row>
                <Row style={{ marginTop: 10 }}>
                  <Col span={12}>
                    <Form.Item name="email" label="邮箱" rules={[{ required: true, message: '请输入邮箱' }]}>
                      <Input placeholder="输入邮箱" style={{ width: 240, height: 40, borderRadius: 5 }} value={this.state.email} onChange={this.emailOnChange} />
                    </Form.Item>
                  </Col>
                  <Col span={12}>
                    <Form.Item name="phone" label="手机" rules={[{ required: true, message: '请输入手机' }]}>
                      <Input placeholder="请输入手机号" style={{ width: 240, height: 40, borderRadius: 5 }} value={this.state.phone} onChange={this.phoneOnChange} />
                    </Form.Item>
                  </Col>
                </Row>
                <Row style={{ marginTop: 10 }}>
                  <Col span={12}>
                    <Form.Item name="school" label="学校" rules={[{ required: true, message: '请输入学校' }]}>
                      <Input placeholder="请输入学校" style={{ width: 240, height: 40, borderRadius: 5 }} value={this.state.school} onChange={this.schoolOnChange} />
                    </Form.Item>
                  </Col>
                  {/* <Col span={12}>*/}
