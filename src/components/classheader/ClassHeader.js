...
import { StarOutlined, EyeOutlined, EditOutlined, ProjectOutlined, TeamOutlined, UserOutlined} from '@ant-design/icons';
            ...
            <div className="class-header">
                <Row>
                    ...
                    <Col span={3} offset={15} style={{display:"flex", paddingTop:3}}>
                        <Button className="class-button"><EyeOutlined />btn1</Button>
                        <Button className="class-button"><StarOutlined />btn2</Button>
                        <Button className="class-button">btn3</Button>
                    </Col>
                </Row>
                <Row>
                    <Col span={24}>
