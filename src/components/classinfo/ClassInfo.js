        ...
        return (
            <div className="class-card">
                ...
                <div className="class-intro">
                    ...
                    <Row>
                        <Col span={24}>
                            <TextArea value={this.state.description} placeholder="请填写课程简介"
                                      autoSize={{minRows: 3, maxRows: 5}} onChange={this.descriptionOnChange}/>
                        </Col>
                    </Row>
                </div>
                <div className="class-detail">
                    ...
                    <Row>
                        <Col span={24}>
                            <TextArea value={this.state.detail} placeholder="请填写课程详情"
                                      autoSize={{minRows: 5, maxRows: 8}} onChange={this.detailOnChange}/>
                        </Col>
                    </Row>
                </div>
